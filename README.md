...
- `baseurl`: The baseurl of the blog. For example, if the `baseurl: 'mineversal.org'`,
  this means that the blog will be reached at http://localhost:4000/mineversal.org.
